...
from scut.data_gen import create_image_gen, create_visit_gen
...
trainImageAug, valImageGen, testImageGen = create_image_gen(100, 100, 3)
trainVisitAug, valVisitGen, testVisitGen = create_visit_gen(26, 24, 7)
